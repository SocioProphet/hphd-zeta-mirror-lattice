"""CLI for the Prime Harness Model 1 π N-scan.

This command requires two independent zero-table files. It is intended for
M2b execution after G0 zero-table provenance is available.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run Model 1 π explicit-formula N-scan")
    ...
    print(f"branch_convention={report.branch_convention}")
    return 0
